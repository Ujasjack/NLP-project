...
train_file = 'preprocessed_fnc_train.csv'
train_df = pd.read_csv(train_file)
train_df.dropna(inplace=True)

test_file = 'preprocessed_fnc_test.csv'
...
train_df=pd.read_csv("fnc_pos_extracted_train.csv")
test_df=pd.read_csv("fnc_pos_extracted_test.csv")

test_df.loc[test_df['POS-pattern']!=-1,:].to_csv("fnc_test_derived_pos_extracted.csv")


train_df.loc[train_df['POS-pattern']!=-1,:].to_csv("fnc_train_derived_pos_extracted.csv")



test_df.loc[test_df['POS-pattern']!=-1,["Headline","Body","Label"]].drop_duplicates().to_csv("fnc_test_derived_preprocessed.csv")


train_df.loc[train_df['POS-pattern']!=-1,["Headline","Body","Label"]].drop_duplicates().to_csv("fnc_train_derived_preprocessed.csv")
